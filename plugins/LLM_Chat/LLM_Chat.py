...
def handle_llm_chat(self_bot, bot, message, user_id, chat_type, permission, log_func):
    ...
    if chat_content:
        ...
        if task_info:
            ...
            handle_ai_chat(bot, target_id, chat_type, chat_content, user_id, nickname, chat_id, message.get("raw_data", {}))
            return True
    ...
    if is_master(user_id, MASTER_ID):
        ...
        if clean_msg.startswith("/设置OpenAI"):
            ...
            handle_vision_switch(bot, target_id, chat_type, clean_msg)
            return True
    ...
    if chat_type == "private" and clean_msg and not clean_msg.startswith("/"):
        ...
        if task_info:
            ...
            handle_ai_chat(bot, target_id, chat_type, raw_msg, user_id, nickname, chat_id, message.get("raw_data", {}))
            return True
    ...
    if chat_type == "group" and clean_msg and not clean_msg.startswith("/"):
        ...
        handle_ai_chat(bot, target_id, chat_type, ai_msg, user_id, nickname, chat_id, message.get("raw_data", {}))
        return True
