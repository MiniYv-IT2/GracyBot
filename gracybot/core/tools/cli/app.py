...
def cmd_status():
    ...
    # 懒加载避免触发机器人日志系统
    from gracybot.core.config import BOT_VERSION, MASTER_ID
    ...
    import subprocess
    try:
        from gracybot.core.config import config_manager
...
def cmd_version():
    """显示版本"""
    from gracybot.core.config import BOT_VERSION as v
