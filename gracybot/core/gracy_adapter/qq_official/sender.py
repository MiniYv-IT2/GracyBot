...
from gracybot.core.gracy_adapter.message import GracyMsg, GracyText, GracyImage
from gracybot.core.gracy_adapter.qq_official.api import QQOfficialAPI
from gracybot.core.gracy_adapter.qq_official.protocol import build_send_payload
...
async def send_message(
    ...
    _temp_files = []
    for seg in segments:
        if isinstance(seg, GracyImage) and not seg.file_path and not seg.url and hasattr(seg, 'file_data') and seg.file_data:
            try:
