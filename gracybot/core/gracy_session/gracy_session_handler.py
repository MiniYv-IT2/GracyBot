...
依赖:
- core.gracy_session.gracy_session_manager
- core.gracy_adapter.send (gracy_send_msg)
- core.gracy_adapter.message (GracyText)
"""
...
def handle_session_command(
    ...
    """
    from gracybot.core.security_manager import security_manager
    from gracybot.core.gracy_session import (
        gracy_get_session,
...
def _handle_clear_session(
    ...
    from gracybot.core.gracy_session import gracy_get_session
    from gracybot.core.gracy_session.gracy_session_manager import gracy_get_session_manager
    ...
    if success:
        ...
        # 会话不存在，也视为成功（创建新的）
        from gracybot.core.gracy_session import gracy_create_session
